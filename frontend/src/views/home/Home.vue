...
import { WrappedMoraLight } from '@mora-light/vue';
...
// import core from './test_loading.json';
// import core from './test_clock2.json';
// import core from './test_bug.json';
// import core from './test_rec.json';
// import core from './test_rec2.json';
// import core from './test_canister.json';
import core from './test_2_canister.json';
// import core from './simple_text.json';
// import core from './input_view.json';
// import core from './test_process.json';
// import core from './test_table_clock.json';
// import core from './test_float64.json';
// import core from './test_clock.json';
// import core from './test_table.json';
// import core from './test_name.json';
// import core from './burning.json';
...
<template>
    <div class="test">
        ...
        <!-- <WrappedMoraLightVue
            :anchor="{ canister_id: 'nciuh-jiaaa-aaaai-qo75a-cai', hash: 'VDDKSXIY3FIZMWJ' }"
        /> -->
        <WrappedMoraLightVue :hostAgent="undefined" :data="data" :status="status" :prop="prop" />
        <!-- <WrappedMoraLightVue :data="{ frozen: '12356' }" /> -->
        <div class="test2">Light Dev End</div>
        <div class="test2">Light Prod Start</div>
        <!-- <WrappedMoraLight :hostAgent="undefined" :data="{ frozen: '12356' }" /> -->
        <!-- <WrappedMoraLight :hostAgent="undefined" :data="data" :status="status" :prop="prop" /> -->
        <div class="test2">Light Prod End</div>
    </div>
</template>
