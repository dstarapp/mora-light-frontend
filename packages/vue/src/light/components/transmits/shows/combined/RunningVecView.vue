...
const props = defineProps({
    ...
    from: {
        type: Object as PropType<VecViewSupportedType>,
        required: true, // The running result type of the light also needs to be used
    },
    constraint: {
        type: Object as PropType<VecViewConstraint>,
        required: true,
    },
    subtype: {
...
const ui = computed<VecUI | undefined>(() => props.constraint.ui);
...
<template>
    <div class="running-vec-view-content">
        ...
        <template v-else>
            ...
            <div class="vec-content" v-if="value !== undefined">
                <div class="vec-content-empty" v-if="valueViews.length === 0">
                    <i class="iconfont icon-no"></i>
                    <p>No data</p>
                </div>
                <div class="vec-content-inner" :class="flexDirection" v-else>
