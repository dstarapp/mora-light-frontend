...
const props = defineProps({
    ...
    from: {
        type: Object as PropType<RecordViewSupportedType>,
        required: true, // The running result type of the light also needs to be used
    },
    constraint: {
        type: Object as PropType<RecordViewConstraint>,
        required: true,
    },
    subitems: {
...
const ui = computed<RecordUI | undefined>(() => props.constraint.ui);
...
<template>
    <div class="running-record-view-content">
        ...
        <template v-else>
            ...
            <div class="record-content" v-if="value !== undefined">
                <div class="record-content-empty" v-if="valueViews.length === 0">
                    <i class="iconfont icon-no"></i>
                    <p>No data</p>
                </div>
                <div class="record-content-inner" :class="flexDirection" v-else>
