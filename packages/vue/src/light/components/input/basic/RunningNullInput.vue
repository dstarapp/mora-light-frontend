...
import { NullCandidType } from '@mora-light/core/types/candid';
...
const props = defineProps({
    ...
    initial: {
        type: Object as PropType<NullCandidType>,
        required: true,
    },
    ui: {
...
const produce = (): DataResult<NullCandidType> => {
    if (!initialed) return { err: { message: `${props.status} null input has not been initial.` } };
...
const emit = defineEmits<{
    changed: [DataResult<NullCandidType>];
}>();
...
<template>
    <div class="running-null-input-content">
        <div class="null-main">
